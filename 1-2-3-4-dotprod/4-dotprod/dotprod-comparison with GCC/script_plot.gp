...
"dotprod_gcc-O2_plotdata.txt" using 2:xtic(1) title "MiB/s (GCC-O2)" linecolor rgb "#606060",\
"dotprod_gcc-O3_plotdata.txt" using 2:xtic(1) title "MiB/s (GCC-O3)" linecolor rgb "#ffff00"
