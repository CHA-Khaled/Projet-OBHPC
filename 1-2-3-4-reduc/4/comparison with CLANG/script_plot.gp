...
"reduc_clang-O2_plotdata.txt" using 2:xtic(1) title "MiB/s (clang-O2)" linecolor rgb "#606060",\
"reduc_clang-O3_plotdata.txt" using 2:xtic(1) title "MiB/s (clang-O3)" linecolor rgb "#ffff00"
